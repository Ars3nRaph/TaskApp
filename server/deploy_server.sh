...
# Script de déploiement restructuré pour le serveur TaskAPP

echo "Démarrage du déploiement du serveur TaskAPP..."
...
# Restructuration des fichiers pour un déploiement plus simple
echo "Restructuration des fichiers..."

# Créer un fichier app.py à la racine
cat > app.py << 'EOF'
...
# Instructions pour le démarrage du serveur
echo "
=================================================
Déploiement du serveur TaskAPP terminé !

Pour démarrer le serveur en développement :
$ source venv/bin/activate
$ python app.py

Pour démarrer le serveur en production avec Gunicorn :
$ source venv/bin/activate
$ gunicorn --bind 0.0.0.0:5000 wsgi:app

Le serveur sera accessible à l'adresse : http://[adresse_ip_serveur]:5000
=================================================
"
